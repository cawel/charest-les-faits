...
FactoryGirl.create(:example, :headline => "Charest aura pris 2 ans avant de déclencher la commission Charbonneau.", :link => "http://www.lefigaro.fr")
FactoryGirl.create(:example, :headline => "Le PLQ est financé par la mafia.", :link => "http://ledevoir.com", :reasons => [r2, r3, r4])
FactoryGirl.create(:example, :headline => "Jean Charest a fait fondre le bonhomme de neige de la place public.", :link => "http://ledevoir.com", :excerpt => "Alors que le soleil plombait et que la promenade s'en allait de part et d'autres. Le bonhomme de neige a fondu, comme une glace sur la grille d'un BBQ. C'est pour dire, seulement 2 ans de ça déjà, et je m'en souviens comme si tout s'était déroulé ce matin même.", :reasons => [r2, r3, r4])
