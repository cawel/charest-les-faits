...
FactoryGirl.create(:example, :headline => "Charest aura pris 2 ans avant de déclencher la commission Charbonneau.", :link => "http://www.lefigaro.fr/article", :approved => true)
FactoryGirl.create(:example, :headline => "Le PLQ est financé par la mafia.", :link => "http://ledevoir.com/topic.html", :reasons => [r2, r3, r4], :approved => true)
